Xcell_IT Timesheet Management System
A complete web based employee timesheet and HR management platform for Scube Soft Solutions

Project Overview
Xcell IT (ATMS) is a Django-based web application that helps employees and HR teams manage working hours, attendance, and timesheet approvals.
